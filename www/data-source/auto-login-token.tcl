...
if {"" == $password || "" == $email} {
    doc_return 200 "application/json" "{\"success\": false, \"message\": \"No email or password specified\"}"
    ad_script_abort
}
...
if {"ok" == $account_status && 0 != $user_id} { 
    ...
    doc_return 200 "application/json" "{\"success\": false, \"message\": \"$auth_message\"}"
    ad_script_abort
}
